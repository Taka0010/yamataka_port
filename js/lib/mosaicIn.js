  ...
  $.fn.mosaicIn = function (options) {
    ...
    return this.each(function () {
      ...
      if (this.tagName.toUpperCase() === 'IMG') {
        ...
        timerId[id] = global.setTimeout(
          $.proxy(waitUntilSuccess, image, id),
          50
        );
      }
    });
    ...
    function loop() {
      ...
      if (condition) {
        if (currentFrame % intervalFrame === 0) {
          reducedWidth =
            minWidth + transition(currentFrame, totalFrames, restWidth);
          reducedHeight =
            minHeight + transition(currentFrame, totalFrames, restHeight);
          ...
          if (reducedWidth !== prevW || reducedHeight !== prevH) {
            ...
            reducedCanvas.width = reducedWidth;
            reducedCanvas.height = reducedHeight;
            reducedCanvasContext.drawImage(
              image,
              0,
              0,
              reducedWidth,
